...
namespace ums {
    class Subsystem
    {
        public:
            ...
            //is base class for derived $Subsystem$Frame. Check derived classes for
        ...
        protected:
            ...
            void setPreviewBufferAddress(Frame* preview_buffer);
            //SETTER: Spins acquistion thread inside derived class constructor.
            //WARN: MUST RUN stopAcquisitionMachinery() in destructor to join thread.
            void startAcquisitionMachinery();
            //WARN: MUST RUN stopAcquisitionMachinery() in destructor to join thread.
            void stopAcquisitionMachinery();

            //Enqueues the prepared frame in the subsystem managed ring buffer.
            void bufferEnqueue(std::unique_ptr<Frame> prepared_frame);

            //HIJINKS: Does Subsystem specific hijinks to get the latest_frame_.
            virtual std::unique_ptr<Frame> acquireLatestFrame() = 0;

            virtual void copyToPreviewBuffer(Frame* frame) = 0;
            ...
            //and memory is freed at end of scope. State flag determines raw and quantised workflows.
            //
            //EXCEPTIONS:
        ...
        private:
            ...
            //Copies latest_frame_ data into class' managed $subsystem$_preview_buffer_.
            //
